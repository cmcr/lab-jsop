...
console.log("%c Chapter 6. More Ex Nihilo Objects", "font-weight: bold");

var frutaApp = {
		
	    delay: 3,
	    appName: "App de frutas",
	    order: "Order",
	    frutas: {},
	    precios: [],

	ponerPrecio: function (precio) {
...
function Paciente (name, age){
	var new_paciente = this;
	this.name = name;
	this.age = age;	
}
Paciente.prototype.dime = function(){return "ay ay";};

loco = new Paciente("Loco", 33);
loco.nivel = function(arg){ return arg;}
console.log(loco);
boco = new Paciente("Boco", 34);
console.log(boco);

//Class-Based Inheritance
console.log("%c Class-Based Inheritance", "font-weight: bold");
